...
export function DriverSettings() {
  ...
  const handleDeleteAccount = async () => {
    ...
    if (!confirm('⚠️ ADVERTENCIA: Se perderán todos tus datos, rutas, vehículos, saldo y transacciones. ¿Deseas continuar?')) {
      return
    }
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Detalles de tu perfil de conductor</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-6">
            {/* Datos Personales */}
        ...
        <CardContent className="pt-6">
          <div className="rounded-lg border border-red-200 bg-red-50 p-4">
            ...
            <ul className="text-sm text-red-800 mb-4 ml-4 list-disc space-y-1">
              ...
              <li>Todas tus rutas activas y completadas</li>
              <li>Vehículos registrados</li>
              <li>Solicitudes de pasajeros</li>
